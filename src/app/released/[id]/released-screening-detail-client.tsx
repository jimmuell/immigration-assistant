...
interface ReleasedScreeningDetailClientProps {
  screening: Screening;
  messages: Message[];
  documents: Document[];
  quote: Quote | null;
...
export default function ReleasedScreeningDetailClient({ 
  screening, 
  messages, 
  documents, 
  quote, 
  clientId 
}: ReleasedScreeningDetailClientProps) {
        ...
        {screening.assignedAttorneyId && (
          <Card className="p-4 mb-6 bg-blue-50 border-blue-200">
            <div className="flex items-center gap-3">
              <div className="h-12 w-12 rounded-full bg-linear-to-br from-blue-400 to-blue-600 flex items-center justify-center text-white text-lg font-medium">
                  ...
                  {responses.map((response, index) => (
                    <div key={index} className="border-b pb-4 last:border-b-0 last:pb-0">
                      <div className="mb-2 flex items-start gap-2">
                        <span className="mt-1 flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-blue-100 text-xs font-semibold text-blue-700">
                          {index + 1}
                        </span>
                        <div className="flex-1">
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="mt-1 text-sm text-blue-700">
                  Your screening has been released to our attorneys. You'll be notified when an attorney has been assigned to review your case.
                </p>
              </div>
            </div>
          </Card>
