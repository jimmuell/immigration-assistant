...
import ReleasedScreeningDetailClient from "./released-screening-detail-client";

interface ReleasedScreeningDetailPageProps {
  params: Promise<{
    id: string;
  }>;
}

export default async function ReleasedScreeningDetailPage({ params }: ReleasedScreeningDetailPageProps) {
