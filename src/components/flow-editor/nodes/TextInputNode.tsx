...
export default memo(function TextInputNode({ data }: NodeProps) {
  ...
  return (
    <div className="px-4 py-3 rounded-lg border-2 bg-card min-w-[200px] shadow-sm border-indigo-500">
      <Handle 
        type="target" 
      ...
      {nodeData.placeholder && (
        <div className="text-xs text-muted-foreground italic">{nodeData.placeholder}</div>
      )}
