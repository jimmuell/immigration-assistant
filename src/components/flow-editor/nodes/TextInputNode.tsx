...
export default memo(function TextInputNode({ data }: NodeProps) {
  ...
  return (
    <div className={`w-[250px] px-4 py-3 rounded-lg border-2 bg-card shadow-sm border-indigo-500 transition-all ${
      ...
      <div className="flex items-center gap-2 mb-1">
        ...
        <div className="font-medium text-sm flex-1">Text Input</div>
        <button
      ...
      {!isCollapsed && (
        <>
          ...
          {nodeData.placeholder && (
            <div className="text-xs text-muted-foreground italic break-words whitespace-normal">{nodeData.placeholder}</div>
          )}
